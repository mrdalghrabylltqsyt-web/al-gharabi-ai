...
const EXTERNAL_SETUP: Record<PlatformId, string[]> = {
  ...
  instagram: ['Meta App + حساب Instagram للأعمال', 'INSTAGRAM_OAUTH_CLIENT_ID / INSTAGRAM_OAUTH_CLIENT_SECRET', 'App Review لصلاحيات الرسائل/التعليقات', 'تسجيل Redirect URI'],
