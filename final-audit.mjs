...
add('meta-dialog-mock-routes', read('engine/tests/helpers/facebookMock.ts').includes("dialogOutcome") && read('engine/tests/helpers/instagramMock.ts').includes("dialogOutcome"), 'الخوادم الوهمية تحاكي حوار Meta (consent/login/invalid_app_id)');
